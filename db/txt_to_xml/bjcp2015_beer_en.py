...
str = re.sub("<stats title=\"pale\">\n\t*\s*<stats>\n\t*\s*<type>srm</type>\n\t*\s*<header></header>", "<stats>\n\t\t\t\t<type>srm</type>\n\t\t\t\t<header>pale</header>", str)
str = re.sub("<stats title=\"dark\">\n\t*\s*<stats>\n\t*\s*<type>srm</type>\n\t*\s*<header></header>", "<stats>\n\t\t\t\t<type>srm</type>\n\t\t\t\t<header>dark</header>", str)
str = re.sub("<stats title=\"standard\">\n\t*\s*<og flexible=\"false\">\n\t*\s*<low>(.*)*</low>\n\t*\s*<high>(.*)*</high>\n\t*\s*</stats>\n\t*\s*" + 
            "<stats>\n\t*\s*<type>fg</type>\n\t*\s*<header></header>\n\t*\s*<notes></notes>\n\t*\s*<low>1.002</low>\n\t*\s*<high>1.008</high>\n\t*\s*</stats>\n\t*\s*" + 
            "<stats>\n\t*\s*<type>abv</type>\n\t*\s*<header></header>\n\t*\s*<notes></notes>\n\t*\s*<low>5.0</low>\n\t*\s*<high>7.0</high>\n\t*\s*</stats>", 
            ...
            "\n\t\t\t<stats>\n\t\t\t\t<type>fg</type>\n\t\t\t\t<header>standard</header>\n\t\t\t\t<notes></notes>\n\t\t\t\t<low>1.002</low>\n\t\t\t\t<high>1.008</high>\n\t\t\t</stats>" + 
            "\n\t\t\t<stats>\n\t\t\t\t<type>abv</type>\n\t\t\t\t<header>standard</header>\n\t\t\t\t<notes></notes>\n\t\t\t\t<low>5.0</low>\n\t\t\t\t<high>7.0</high>\n\t\t\t</stats>", str)
str = re.sub("<stats title=\"table\">\n\t*\s*<stats>\n\t*\s*<type>abv</type>\n\t*\s*<header></header>", "<stats>\n\t\t\t\t<type>abv</type>\n\t\t\t\t<header>table</header>", str)
str = re.sub("<stats title=\"super\">\n\t*\s*<stats>\n\t*\s*<type>abv</type>\n\t*\s*<header></header>", "<stats>\n\t\t\t\t<type>abv</type>\n\t\t\t\t<header>super</header>", str)
str = re.sub("</stats>\n\t*\s*</stats>", "</stats>", str)
